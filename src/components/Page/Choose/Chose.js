      ...
      <div className='choose__effect'></div>
        ...
        <div className='choose__info'>
          ...
          <p className='choose__paragraph'>Cillum ipsum officia laborum
           ...
           sint ut esse sunt quis sint consequat dolor.
           Non et dolor laboris duis irure ut do eu fugiat
           velit eu deserunt. </p>
          <p className='choose__paragraph'>Id exercitation qui
          sunt in reprehenderit sunt.</p>
        </div>
    </section>
  )
}
